...
import profilePic from "../../assets/images/profile/computer photo (3).png";
...
export default function Home() {
  useTitle('SM_Portfolio: Home Page')
  return (
    <>     
      <TransitionEffect />
      <article
          ...
          <div className="pt-12 flex w-full items-start justify-between md:flex-col">
            ...
            <div className="flex w-1/2 flex-col items-center self-center lg:w-full lg:text-center pl-8">
              ...
              <p className="my-4 text-base font-medium md:text-sm sm:!text-xs">
                ...
                skills I&apos;ve honed as a developer. I hope you find it enjoyable!
              </p>
