    ...
    <>
      ...
      <AnimatedUnderline />
        ...
        >
          ...
          psychology degree, ventured into education, and found my true passion
          in web development. Through teaching and curriculum digitization to
          leading professional development training on integrating these
          technologies in the classroom, I discovered the magic of coding. Now,
          I'm embarking on a new adventure in the world of web development. Join
          me as I explore this exciting path, one line of code at a time. 💻✨
        </motion.p>
        </div>
        </div>
